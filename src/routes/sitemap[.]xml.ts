    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/party-orders", changefreq: "monthly", priority: "0.8" },
          { path: "/training", changefreq: "monthly", priority: "0.8" },
          { path: "/dealers", changefreq: "monthly", priority: "0.8" },
          { path: "/overseas", changefreq: "monthly", priority: "0.8" },
          { path: "/sell-with-us", changefreq: "monthly", priority: "0.7" },
          { path: "/backlinks", changefreq: "monthly", priority: "0.5" },
